...
<div class="page-wraper"> 
                    	...
                    	<div class="rdx-topbar-left">
							<ul class="social-line text-center pull-right">
								...
								<li><a href="javascript:void(0);"><i class="fa fa-envelope-o text-primary"></i> <span>info@ritedu.in</span></a></li>
							     <li><a href="images/EOA Report_2018-19.PDF"> Approval Letter</a></li><li><a href="grievance-Complaint.aspx"> Grievance Complaint</a></li>
                            </ul>
                        </div>                        
   ...
   <div class="page-content">
        <!-- inner page banner -->
       <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3489.985344822667!2d79.3417841148482!3d28.987805282279005!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39a07febd2b83f5d%3A0x60116070bfb244f!2sRudrapur+Institute+of+Technology!5e0!3m2!1sen!2sin!4v1522354884006" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="p-a30 bg-white clearfix m-b30">
							<form method="post" class="dzForm" action="script/contact.php" runat="server">
							<input type="hidden" value="Contact" name="dzToDo" >
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="input-group"> <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                                <input name="dzName" id="fname" runat="server" type="text" required class="form-control " placeholder="Input Your Name">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="input-group"> <span class="input-group-addon"><i class="fa fa-phone-square"></i></span>
                                                <input name="dzMobile" id="mno" runat="server" type="text" class="form-control" required placeholder="Input Mobile No." >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="input-group"> <span class="input-group-addon v-align-t"><i class="fa fa-pencil"></i></span>
                                                <textarea name="dzMessage" id="messsgae" runat="server" rows="4" class="form-control" required  placeholder="Input Your Message"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <asp:Button ID="submit" Text="Submit" runat="server" CssClass="site-button" OnClick="submit_Click" />
                            ...
                            <ul class="no-margin">
                                <li class="icon-bx-wraper left m-b30">
                                    ...
                                    <div class="icon-content">
                                        ...
                                        <p>Rudrapur, Kashipur Road, Vill- Bhagwanpur, 
P.O.- Danpur, Rudrapur - 263153</p>
                                    </div>
                                </li>
                                <li class="icon-bx-wraper left  m-b30">
                                ...
                                <li class="icon-bx-wraper left">
                                    ...
                                    <div class="icon-content">
                                        ...
                                        <p>+91-8194033335, 05944-261757</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
